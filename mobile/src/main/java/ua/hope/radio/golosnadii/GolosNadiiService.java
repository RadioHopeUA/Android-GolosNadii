 ...
 */
public class GolosNadiiService extends Service implements GolosNadiiPlayer.Listener, GolosNadiiPlayer.Id3MetadataListener,
        AudioCapabilitiesReceiver.Listener, IGolosNadiiService, AudioManager.OnAudioFocusChangeListener {
    private static final String TAG = "GolosNadiiService";
    ...
    private GolosNadiiPlayer player;
    ...
    private IGolosNadiiServiceCallback callback;
    ...
    public void onCreate() {
        ...
        Intent notificationIntent = new Intent(this, GolosNadiiMainActivity.class);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);

        PendingIntent stopPendingIntent = PendingIntent.getService(this, 0,
                new Intent(this, GolosNadiiService.class).setAction("stop"), 0);
    ...
    public void setSelectedTrack(int id) {
        if (player != null) {
            player.setSelectedTrack(GolosNadiiPlayer.TYPE_AUDIO, id);
        }
    }
    ...
    public int getSelectedTrack() {
        if (player == null) {
            ...
            return player.getSelectedTrack(GolosNadiiPlayer.TYPE_AUDIO);
        }
    }
    ...
    public int getTrackCount() {
        if (player == null) {
            ...
            return player.getTrackCount(GolosNadiiPlayer.TYPE_AUDIO);
        }
    }
    ...
    public MediaFormat getTrackFormat(int id) {
        if (player == null) {
            ...
            return player.getTrackFormat(GolosNadiiPlayer.TYPE_AUDIO, id);
        }
    }

    @Override
    public void registerCallback(IGolosNadiiServiceCallback callback) {
    ...
    private GolosNadiiPlayer.RendererBuilder getRendererBuilder() {
    ...
    private void preparePlayer(boolean playWhenReady) {
        if (player == null) {
            player = new GolosNadiiPlayer(getRendererBuilder());
    ...
    // GolosNadiiPlayer.Listener implementation
    @Override
    ...
    // GolosNadiiPlayer.MetadataListener implementation
    @Override
    ...
    public class MusicBinder extends Binder {
        GolosNadiiService getService() {
            return GolosNadiiService.this;
        }
    }
}
