 ...
 */
public class GolosNadiiMainActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "GolosNadiiMainActivity";
    ...
    private IGolosNadiiService mHopeFMService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wwwButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(GolosNadiiMainActivity.this, wwwButton);
    ...
    protected void onStart() {
        super.onStart();
        Intent intent = new Intent(this, GolosNadiiService.class);
        startService(intent);
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            GolosNadiiService.MusicBinder binder = (GolosNadiiService.MusicBinder) service;
    ...
    private IGolosNadiiServiceCallback mCallback = new IGolosNadiiServiceCallback() {
        @Override
