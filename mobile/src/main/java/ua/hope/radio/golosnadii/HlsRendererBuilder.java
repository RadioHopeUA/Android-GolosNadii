...
public class HlsRendererBuilder implements GolosNadiiPlayer.RendererBuilder {
    ...
    @Override
    public void buildRenderers(GolosNadiiPlayer player) {
    ...
    private static final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<HlsPlaylist> {
        ...
        private final Context context;
        private final String userAgent;
        private final GolosNadiiPlayer player;
        private final ManifestFetcher<HlsPlaylist> playlistFetcher;

        private boolean canceled;

        public AsyncRendererBuilder(Context context, String userAgent, String url, GolosNadiiPlayer player) {
            this.context = context;
            this.userAgent = userAgent;
            this.player = player;
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                    MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, GolosNadiiPlayer.TYPE_VIDEO);
            ...
            if (haveSubtitles) {
                ...
                HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
                        TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, GolosNadiiPlayer.TYPE_TEXT);
                textRenderer = new TextTrackRenderer(textSampleSource, player, mainHandler.getLooper());
            } else {
                textRenderer = new Eia608TrackRenderer(sampleSource, player, mainHandler.getLooper());
            }

            TrackRenderer[] renderers = new TrackRenderer[GolosNadiiPlayer.RENDERER_COUNT];
            renderers[GolosNadiiPlayer.TYPE_VIDEO] = videoRenderer;
            renderers[GolosNadiiPlayer.TYPE_AUDIO] = audioRenderer;
            renderers[GolosNadiiPlayer.TYPE_METADATA] = id3Renderer;
            renderers[GolosNadiiPlayer.TYPE_TEXT] = textRenderer;
