 ...
 */
public class GolosNadiiPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link GolosNadiiPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link GolosNadiiPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(GolosNadiiPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link GolosNadiiPlayer#onRenderers} or
     * {@link GolosNadiiPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
  ...
  public GolosNadiiPlayer(RendererBuilder rendererBuilder) {
   ...
   *
   * @param renderers Renderers indexed by {@link GolosNadiiPlayer} TYPE_* constants. An individual
