 ...
 */
public class EventLogger implements GolosNadiiPlayer.Listener, GolosNadiiPlayer.InfoListener,
    GolosNadiiPlayer.InternalErrorListener {
  ...
  public EventLogger() {
    loadStartTimeMs = new long[GolosNadiiPlayer.RENDERER_COUNT];
  }
